      ...
      if(isset($_POST['eventbtn']))
{
	$event_name=$_POST['event_name'];
	 ...
	 $query="INSERT INTO event_name( event_name) VALUES('$event_name')";
	$query_run=mysqli_query($connection,$query);

	if ($query_run) {
		
		$_SESSION['success']="Event Added";
		header('Location:eventsdetail.php');
	}
	else{
...
?>
  ...
  $result_count = mysqli_query($connection,"SELECT COUNT(*) As total_records FROM event_name");
  $total_records = mysqli_fetch_array($result_count);
  $total_records = $total_records['total_records'];
  $total_no_of_pages = ceil($total_records / $total_records_per_page);
  $seconnd_last = $total_no_of_pages - 1; // total page minus 1

  $result = mysqli_query($connection,"SELECT * FROM event_name LIMIT $offset, $total_records_per_page");
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger"><a style="color:white" href="eventdelete.php?id=<?php echo $row ['event_id'];?>">DELETE</a></button>
                            </td>
